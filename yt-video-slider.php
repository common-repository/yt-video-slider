<?php
/*
Plugin Name: YT Video Slider
Plugin URI: https://wordpress.org/plugins/yt-video-slider/
Description: YT Slider - An awesome youtube hosted video slider.
Version: 1.1
Author: twidgets
...
class RealYoutubeSlider{
    ...
    public static function add_youtube_tools_options_page(){
        ...
        add_options_page('YT Video Slider', 'YT Video Slider ', 'administrator', __FILE__, array('RealYoutubeSlider','real_youtube_tools_options'));
...
<div class="wrap">
    ...
    <h2>YT (Youtube) Slider Configuration</h2>
...
<?php
    ...
    public function real_utube_register_settings_and_fields(){
        ...
        add_settings_field('youtube_url', 'Youtube Video ID', array($this,'pageURL_settings'), __FILE__,'real_youtube_main_section');
...
$print_youtube = '';
if($youtube_url == ''){
$print_youtube.='<div class="error_kudos">Please Fill Out The YT (Youtube) Slider Configuration First</div>';	
} else {
$print_youtube .= '
